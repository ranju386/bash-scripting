...
![shell script](https://github.com/ranju386/bash-scripting/blob/main/devops-task6.jpg)
Explanation
...
![sed command](https://github.com/ranju386/bash-scripting/blob/main/devops-task7.jpg)
